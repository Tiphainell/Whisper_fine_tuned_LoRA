...
python Script_transcription.py
#adfluo extract soranos.extractions.counting_whisper.extractor  soranos.dataloaders.HDParkDataset --hparams task=1-20 -o extractions/full_whisper_1_20.csv
